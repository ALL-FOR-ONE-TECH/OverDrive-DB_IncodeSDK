"""
OverDrive InCode SDK — Python Wrapper (v2.0.0)
...
def _find_library() -> str:
    ...
    search_paths = [
        ...
        Path(__file__).parent.parent.parent.parent / "native" / platform_dir / lib_name,
        Path(__file__).parent.parent.parent.parent / "native" / "windows" / lib_name,  # Windows fallback
        ...
        Path(__file__).parent.parent.parent.parent / "target" / "release" / alt_name,
    ]
